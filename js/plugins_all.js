...
(function($) {
    ...
    $.ajaxChimp = {
        responses: {
            "Мы отправили вам письмо в подтверждение!": 0,
            "Пожалуйста, введите данные": 1,
            "Email адрес должен содержать один символ @": 2,
            "Доменная часть адреса E-mail неверна (часть после символа @: )": 3,
            "Часть имени адреса E-mail неверна (часть до символа @: )": 4,
            "Этот адрес E-mail выглядит неправдоподобным или неверным. Введите, пожалуйста, корректный адрес": 5
        },
        translations: {
            en: null
        },
            ...
            form.submit(function() {
                ...
                function successCallback(resp) {
                    if (resp.result === "success") {
                        msg = "Мы отправили вам письмо в подтверждение";
